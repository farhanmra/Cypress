describe('day 6',function(){
    it('Latihan',function(){
        ...
        // cy.get('.subjects-auto-complete__value-container').type('Arts').should('have.value','subjek')
        ...
        // cy.contains('NCR').select({force:true})
        // cy.get('[data-layer="Content"]').should('be.hidden')
        cy.get('#submit').click()
